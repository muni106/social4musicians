...
CREATE TABLE INFLUENCE(
    genreName VARCHAR(16) NOT NULL FOREIGN KEY REFERENCES GENRE 
        ON DELETE CASCADE
        ON UPDATE NO ACTION,
...
ADD FOREIGN KEY (genreName) REFERENCES GENRE(genreName)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ADD FOREIGN KEY (nickname) REFERENCES MUSICIAN(nickname)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
ADD FOREIGN KEY (chatID) REFERENCES CHAT(chatID)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
ADD FOREIGN KEY (participantID) REFERENCES CHAT_PARTICIPANT(participantID)
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
